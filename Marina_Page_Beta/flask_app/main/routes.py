...
@main_bp.route("/contact_page/update_contact_page", methods=['GET', 'POST'])
@login_required
def update_contact_page():
    return redirect(url_for('main_bp.home'))

# add edit blog page
@main_bp.route("/blog/update_blog", methods=['GET', 'POST'])
@login_required
def update_blog():
    return redirect(url_for('main_bp.home'))
